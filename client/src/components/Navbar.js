...
<div>
  { !isAuth? (<Link to='/' className="navbar-brand font-navbar">INFO JOBS</Link>):
  user.role === "entreprise" ?
  (<Link className="navbar-brand font-navbar">INFO JOBS</Link>):
  (<Link to='/' className="navbar-brand font-navbar">INFO JOBS</Link>)
  }
  </div>
{!isAuth? (
  ...
  <ul className="navbar-nav">
  <li className="nav-item active">
   <Link to='/JobCardEntreprise' className="nav-link text-light font-sub-nav">Nos Offres</Link>
</li>
<li className="nav-item active">
