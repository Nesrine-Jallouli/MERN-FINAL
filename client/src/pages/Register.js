...
{errors.msg} </div>: null
    ...
    <FormGroup>
      ...
      {/* <div>
        ...
        <div className="form-check form-switch">
          <input className="form-check-input" type="checkbox" id="flexSwitchCheckChecked"  value={role} onChange={(e) => setRole(e.target.value)}/>
      ...
      <Label for="name">Role (candidat/entreprise)</Label>
        <Input type="text" name="name" id="name" value={role} onChange={(e) => setRole(e.target.value)} placeholder="candicat ou bien entreprise" required/>
      <FormGroup>
