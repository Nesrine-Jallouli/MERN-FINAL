  ...
  return (
    ...
    <div className="row">
      <div className="col-md-3 border-right">
        <div className="d-flex flex-column align-items-center text-center p-3 py-5"><img className="rounded-circle mt-5" src="https://bootdey.com/img/Content/avatar/avatar7.png" /><span className="font-weight-bold">{user.name}</span><span> </span></div>
      </div>
